    ...
    navigator.geolocation.getCurrentPosition(
      function(pos) {
        ...
        routeControl = L.Routing.control({
          ...
          // Request alternatives from OSRM (we'll not draw them all; provide UI to select)
          router: L.Routing.osrmv1({ serviceUrl: 'https://router.project-osrm.org/route/v1', alternatives: true }),
        ...
        // When routes are found, build an alternative-selection control (no multiple lines)
        routeControl.on('routesfound', function(e){
          ...
          } catch(err) { console.error('routesfound alt ui err', err); }
        });
